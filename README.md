...
* Travis CI:
    ...
    * "release" branch [![Build Status](https://travis-ci.org/aws-robotics/kinesisvideo-ros1.svg?branch=release-v2)](https://travis-ci.org/aws-robotics/kinesisvideo-ros1/branches)
* ROS build farm:
